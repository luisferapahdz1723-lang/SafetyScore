          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-surface-alt p-6 border border-border">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-3xl font-bold text-content uppercase tracking-tight">{opportunity.name}</h1>
              ...
              <div className="relative w-40 h-40 mb-4">
                <svg className="w-full h-full" viewBox="0 0 100 100">
                  ...
                  <motion.circle
                    ...
                    animate={{ strokeDashoffset: 282.7 * (1 - opportunity.safetyScore / 100) }}
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-4xl font-mono font-bold text-content">{opportunity.safetyScore.toFixed(1)}</span>
          ...
          <div className="sticky top-6 space-y-4">
            <div className="glass-panel p-6 border-border rounded-none bg-surface-alt/30">
              <div className="text-center mb-6">
                ...
                <div className="text-3xl font-mono font-bold text-content">${opportunity.amount.toLocaleString()}</div>
              </div>
              ...
              <div className="space-y-6 mb-6">
                <div className="space-y-2">
                  <div className="flex justify-between text-[9px] font-mono uppercase tracking-tighter">
                    ...
                    <span className="text-primary">{opportunity.fundedPercentage}%</span>
                  </div>
                  <div className="h-1 w-full bg-surface-alt overflow-hidden">
                    <motion.div 
                      className="h-full bg-primary"
                      initial={{ width: 0 }}
                      animate={{ width: `${opportunity.fundedPercentage}%` }}
                    />
                  </div>
                  <div className="flex justify-between text-[8px] text-content-muted font-mono uppercase">
                    <span>$100.5K_COMMITTED</span>
                    <span>GOAL: $150K</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-3 border border-border bg-surface-alt">
                    ...
                    <div className="text-lg font-mono font-bold text-emerald-500">{opportunity.roi.toFixed(2)}%</div>
                  </div>
                  <div className="p-3 border border-border bg-surface-alt">
                    <div className="text-[8px] text-content-muted uppercase font-mono mb-1">TERM_M</div>
                    <div className="text-lg font-mono font-bold text-primary">{opportunity.term}</div>
                  </div>
                </div>
              ...
              <button className="btn-primary w-full py-3 text-xs font-mono rounded-none uppercase tracking-widest shadow-lg shadow-primary/10">
                EXECUTE_INVESTMENT
              </button>
