...
export const PymeDashboard: React.FC<PymeDashboardProps> = ({ onNavigate }) => {
  ...
  const actions = [
    {
      label: 'Editar mi necesidad',
      icon: <Edit3 className="text-brand-blue" size={32} />,
      color: 'bg-brand-blue/10',
      onClick: () => onNavigate('pyme-wizard'),
    },
    {
        ...
        <div className="glass-panel rounded-[2rem] p-8">
          ...
          <div className="space-y-6">
            {[
              ...
              { title: 'SafetyScore Actualizado', desc: 'Subiste 3 puntos por consistencia en ventas.', time: 'Ayer', icon: <TrendingUp className="text-brand-blue" />, onClick: () => onNavigate('pyme-score') },
            ].map((item, i) => (
              <div
                key={i}
