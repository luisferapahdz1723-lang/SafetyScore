...
INSERT IGNORE INTO opportunities (id, business_id, requested_amount, funded_amount, expected_roi, term_months, fund_destination, description, status, marketplace_status, closes_at) VALUES
('aaaa1111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 150000.00, 100500.00, 17.3, 6, 'Inventario', 'Ampliación de inventario', 'open', 'high-demand', DATE_ADD(NOW(), INTERVAL 12 DAY)),
('aaaa9999-9999-9999-9999-999999999999', '99999999-9999-9999-9999-999999999999', 300000.00, 50000.00, 15.5, 12, 'Expansión', 'Expansión de sucursal de prueba', 'open', 'new', DATE_ADD(NOW(), INTERVAL 25 DAY));

-- Asignar la inversión de la Demo a nuestro Investor
INSERT IGNORE INTO investments (id, investor_id, opportunity_id, amount, status, next_payment_date, monthly_payment) VALUES
('invv1111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000099', 'aaaa9999-9999-9999-9999-999999999999', 50000.00, 'active', DATE_ADD(NOW(), INTERVAL 15 DAY), 4500.00);
