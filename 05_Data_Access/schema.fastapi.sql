...
CREATE TABLE IF NOT EXISTS opportunities (
  ...
  goal_title VARCHAR(255) NOT NULL DEFAULT 'Capital de trabajo',
  goal_description TEXT,
  goal_category ENUM('equipo', 'inventario', 'remodelacion') NOT NULL DEFAULT 'inventario',
  goal_total_units INT NOT NULL DEFAULT 1,
  goal_unit_cost DECIMAL(12, 2) NOT NULL DEFAULT 0,
  goal_current_units_funded INT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS investments (
  ...
  contributed_units INT NOT NULL DEFAULT 0,
